        ...
        {infoarray.map((elem, idx) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mt-3">
              <span className="text-sm text-white">{elem.date}</span>
              <button onClick={() => handledelete(idx)} className=" bg-red-700 px-3 py-1 cursor-pointer rounded-2xl text-white "> Delete </button>
